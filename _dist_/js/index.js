...
const formatPrice = (price) =>
  ...
  async function loadAvocados(url) {
  ...
  const nodeArray = allAvos.map((avocado) => {
    ...
    price.className = "text-gray-600 font-semibold";
    ...
    card.className = "md:flex bg-white rounded-lg p-6 hover:bg-gray-300 border-solid border-2 border-green-500 bg-green-100";
